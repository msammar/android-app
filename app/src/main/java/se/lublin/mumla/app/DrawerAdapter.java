...
//    public static final int ITEM_LAN = 7;
    ...
    public static final int ITEM_ADMIN = 11;
    public static final int ITEM_LOGOUT = 12;
    ...
    public DrawerAdapter(Context context, DrawerDataProvider provider) {
        ...
        //add(new DrawerAdapter.DrawerItem(ITEM_SERVER, context.getString(R.string.drawer_login), R.drawable.ic_action_channels));
        ...
        add(new DrawerAdapter.DrawerItem(ITEM_ADMIN, context.getString(R.string.action_adminpanel), R.drawable.ic_action_settings));
        add(new DrawerAdapter.DrawerItem(ITEM_LOGOUT,"Logout", R.drawable.ic_action_logout));
    }
